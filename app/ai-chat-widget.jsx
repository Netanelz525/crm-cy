    ...
    <div className={`ai-chat-message ai-chat-message-${message.role}`}>
      ...
      {message.pendingAction ? (
        <div className="ai-chat-decision-row">
          {message.pendingAction.type === "attach_document" ? (
            <>
              <button type="button" onClick={() => onDecision(message, "attach_only")} disabled={deciding}>שייך צילום בלבד</button>
              <button type="button" onClick={() => onDecision(message, "approve")} disabled={deciding}>שייך ועדכן שדות</button>
            </>
