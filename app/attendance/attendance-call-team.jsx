...
export default function AttendanceCallTeam({ sessionId, team, rosterIds }) {
  ...
  return <section id="call-results" className="card attendance-call-team-panel">
