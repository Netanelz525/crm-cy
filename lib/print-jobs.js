...
export async function createPrintJobFromBuffer({ buffer, fileName, contentType = "application/octet-stream", outputMode = DEFAULT_OUTPUT_MODE, copies = 1, printPlan = DEFAULT_PRINT_PLAN, uploadedByUserId, user = null }) {
  await initDb();
