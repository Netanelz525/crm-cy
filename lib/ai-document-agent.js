...
function buildDocumentWorkflowReply(storedDocument) {
  return [
    `קיבלתי את המסמך: ${clean(storedDocument?.fileName) || "ללא שם"}`,
    "",
    "מה לעשות בו?",
    "ברירת מחדל: הדפסה.",
    "בחר תוכנית הדפסה וכמות עותקים מתוך האפשרויות שאשלח.",
    "אם צריך לשייך לכרטיס תלמיד, בחר שיוך לתלמיד."
  ].join("\n");
}
