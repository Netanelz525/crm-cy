...
const MISSING_FIELD_ALIASES = [
  { field: "tznum", label: 'ת"ז', patterns: ['ת"ז', "תז", "מספר זהות", "מס זהות", "תעודת זהות", "שדה תז", "שדה תעודת זהות"] },
  { field: "dateofbirth", label: "תאריך לידה", patterns: ["תאריך לידה", "ת. לידה", "לידה"] },
  { field: "phone.primaryPhoneNumber", label: "טלפון תלמיד", patterns: ["טלפון תלמיד", "טלפון של התלמיד", "שדה הטלפון", "טלפון", "נייד", "פלאפון"] },
  ...
  { field: "adders.addressStreet1", label: "כתובת", patterns: ["כתובת", "הכתובת", "כתובת מלאה", "מידע כתובת", "שדה הכתובת", "רחוב", "כתובת מגורים"] },
