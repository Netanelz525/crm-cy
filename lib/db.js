...
export async function initDb() {
  ...
  await sql`
    CREATE TABLE IF NOT EXISTS print_jobs (
      ...
      print_plan TEXT NOT NULL DEFAULT 'booklet',
      page_count INTEGER,
  ...
  await sql`ALTER TABLE print_jobs ADD COLUMN IF NOT EXISTS print_plan TEXT NOT NULL DEFAULT 'booklet'`;
  ...
  await sql`
    UPDATE print_jobs
    SET print_plan = CASE
      WHEN print_plan = 'corner-staple-rtl' THEN 'corner-staple'
      WHEN print_plan IN ('booklet', 'duplex', 'corner-staple', 'convert-pdf') THEN print_plan
      ELSE 'booklet'
    END
  `;
  ...
  await sql`ALTER TABLE print_job_uploads ADD COLUMN IF NOT EXISTS print_plan TEXT NOT NULL DEFAULT 'booklet'`;
