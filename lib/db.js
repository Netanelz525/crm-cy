...
export async function initDb() {
  ...
  await sql`ALTER TABLE attendance_records ALTER COLUMN status SET DEFAULT 'present'`;
  await sql`UPDATE attendance_records SET status = COALESCE(NULLIF(status, ''), 'present')`;
