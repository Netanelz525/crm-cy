...
export async function initDb() {
  ...
  await sql`UPDATE attendance_sessions SET communication_audience = 'student' WHERE communication_audience NOT IN ('student', 'parents') OR communication_audience IS NULL`;
