...
import { renderInstitutionPdf } from "./institution-pdf.js";
import { listPaymentConnections, getPaymentDashboard, getPaymentMandatesDashboard } from "./payment-systems.js";
import { filterAndSortPaymentTransactions, summarizePaymentTransactions } from "./payment-report.js";
...
function parseSearchParams(input) {
  ...
  return {
    ...
    searchTerm: clean(searchParams.get("searchTerm")),
