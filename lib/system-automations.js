...
const AUTOMATION_DEFINITIONS = [
  ...
  },
  {
    ...
    schedule: "כל יום ב-18:00 UTC",
    target: "אחראים למשימות עם תזכורת למחר",
    description: "שולח מייל יום לפני תאריך התזכורת שנרשם ביומן הפעולות של המשימה."
  },
  {
    jobName: "monthly-payment-mandate-issues-report",
    title: "דוח חודשי הוראות קבע כושלות",
    kind: "cron",
    path: "/api/cron/monthly-payment-mandate-issues",
    schedule: "ב-27 לחודש ב-06:00 UTC",
    target: "משתמשי super_admin",
    description: "מייצר דוח הוראות קבע כושלות מכל מערכות התשלום הפעילות ושולח אותו במייל עם Excel ו-PDF."
  },
  {
    jobName: "monthly-payment-student-linking",
    title: "שיוך חודשי של תשלומים לתלמידים",
    kind: "cron",
    path: "/api/cron/monthly-payment-student-linking",
    schedule: "ב-1 לחודש ב-04:00 UTC",
    target: "עסקאות החודש הקודם והוראות הקבע הפעילות",
    description: "משייך לתלמיד אוטומטית רק כאשר לפחות שני מזהים חזקים תואמים."
  }
];
